...
export const dateTime = val => moment(val).format('YYYY-MM-DD HH:mm:ss')
export const startOfDateTime = val => moment(val).startOf('day').format('YYYY-MM-DD HH:mm:ss')
export const endOfDateTime = val => moment(val).endOf('day').format('YYYY-MM-DD HH:mm:ss')
